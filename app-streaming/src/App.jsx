      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[1440px] flex-col gap-6 px-4 py-10 sm:px-6 sm:py-6 xl:flex-row xl:items-start xl:px-7">
        ...
        {!sidebarAbierta && (
          <button
            ...
            className="h-14 w-14 shrink-0 rounded-2xl bg-black text-slate-100 transition hover:bg-slate-900"
        ...
        {sidebarAbierta && (
        <div className="w-full max-w-[280px] shrink-0 overflow-hidden transition-all duration-300 ease-in-out">
          <Sidebar>
            <SidebarHeader>
              ...
              <SidebarBody>
                <SidebarSection>
                  ...
                  <SidebarItem href="/CamaraConfig">
                    <CamaraConfigIcon/>
                    <SidebarLabel>Conf Cámara</SidebarLabel>
                  </SidebarItem>
                </SidebarSection>
              </SidebarBody>
            </Sidebar>
